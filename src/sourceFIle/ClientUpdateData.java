...
public class ClientUpdateData extends javax.swing.JFrame {
    Connection con = null;
    ...
    public ClientUpdateData() {
     ...
     public ClientUpdateData(String User) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Client Update Form");
        setBackground(new java.awt.Color(255, 51, 0));
        setForeground(java.awt.Color.red);
        setMinimumSize(new java.awt.Dimension(1350, 850));
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(1470, 950));
        setResizable(false);
        ...
        jLabel1.setText("Client Update From");
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        if(checkData()){
            try{
                ...
                String sql = "UPDATE clientregistrationdata SET FirstName=?,LastName=?,PhoneNo=?,Email=?,State=?,City=?,Gender=? WHERE TourId=?";
                con = db.Connect.getConnection();
                pst = con.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientUpdateData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientUpdateData().setVisible(true);
            }
        });
    }
